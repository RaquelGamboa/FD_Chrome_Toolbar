...
var bannercontent ='';
bannercontent = bannercontent+'<iframe id="banner" src="http://raquel.dwalliance.com/fetchdeals/banners/banner_noautoredirect2.php?mid='+scriptOptions.mid+'&memid='+scriptOptions.memid+'" scrolling="no"></iframe>';
